...
inline fun <reified R : Role> AuthenticationUser.check(required: R): Boolean = userRole.roles.check(required)
...
data class UserRole(
    ...
    override fun toString(): String = roles.toString()
...
fun fromUserRoleString(role: String): UserRole? =
    runCatching {
